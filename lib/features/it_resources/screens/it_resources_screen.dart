...
class ItResourcesScreen extends StatelessWidget {
  const ItResourcesScreen({super.key});
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text('IT Resources', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
            SizedBox(height: 8),
